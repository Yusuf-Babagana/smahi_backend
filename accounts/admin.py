...
class UserAdmin(BaseUserAdmin):
    ...
    list_filter = ['role', 'is_verified', 'is_active', 'created_at', 'country']
    ...
    fieldsets = (
        ...
        ('Permissions', {'fields': ('role', 'account_status', 'is_verified', 'is_active', 'is_staff', 'is_superuser', 'groups', 'user_permissions')}),
